...
class CreateTicket(graphene.Mutation):
    ...
    def mutate(self, info, description=None, priority=None, sprint_name=None, project_name="NOPROJECT",
               story_points=None, ticket_type=None, active_user_id=None, status_id=None):
